import { e as createComponent, m as maybeRenderHead, g as addAttribute, r as renderTemplate, l as renderScript, k as renderComponent } from '../chunks/astro/server_Bofzg8wA.mjs';
import { $ as $$Layout } from '../chunks/Layout_fzqVX3DA.mjs';
import 'clsx';
/* empty css                                 */
import { $ as $$PillarsSection } from '../chunks/PillarsSection_Bb5mKydL.mjs';
...
</p> </div> <div class="what-we-do-image" data-astro-cid-bwyb34ae> <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WEB%20Homepage%20What%20we%20do-QUdEQy3wMjs5h21PcCOL6XKHxANN4V.jpg" alt="Happy family in front of their home" data-astro-cid-bwyb34ae> </div> </div> </section> `;
...
const $$WhoWeServeSection = createComponent(($$result, $$props, $$slots) => {
  const serveItems = [
    {
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WEB%20Homepage%20who%20we%20serve%201-fZB0hqMFruSVPZqSp0nFMqFPLJWvW0.jpg",
    ...
    {
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WEB%20Homepage%20Who%20we%20serve%202-tOWYur6X23N1tTc8HuTAyMIFzSfNQF.jpg",
    ...
    {
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WEB%20Homepage%20Who%20we%20serve%203-1tPyKwC2r0yxKjbGGfPKH6CQ3jNSsY.jpg",
...
const $$SmartStartSection = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="smart-start" data-astro-cid-xigjce2k> <div class="smart-start-container" data-astro-cid-xigjce2k> <div class="smart-start-image-wrapper" data-astro-cid-xigjce2k> <div class="smart-start-frame" data-astro-cid-xigjce2k></div> <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WEB%20homepage%20Smart%20Start-wVq5OtE3UVruWI5zpIln8veQhmDn89.jpg" alt="Smart Start - Community support program" data-astro-cid-xigjce2k> </div> <div class="smart-start-content" data-astro-cid-xigjce2k> <div class="smart-start-logo" data-astro-cid-xigjce2k> <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Logo_Smart%20Start%20-%20Blue-Gray%402x-W2NJw6V57nfVhvXJ58LBqYSHKmvDtA.png" alt="Smart Start Logo" data-astro-cid-xigjce2k> </div> <div class="smart-start-text" data-astro-cid-xigjce2k> <p data-astro-cid-xigjce2k>Smart Start is our way of supporting the community we live in and helping more people enjoy technology that feels simple, reliable and easy to trust every day.</p> <p data-astro-cid-xigjce2k>Each month we choose one local household or small business to receive a complimentary smart technology upgrade that makes everyday life a little easier, safer or more enjoyable.</p> <p data-astro-cid-xigjce2k>Anyone can enter.</p> </div> <a href="/smart-start" class="btn btn-primary" data-astro-cid-xigjce2k>Enter or Nominate</a> </div> </div> </section> `;
